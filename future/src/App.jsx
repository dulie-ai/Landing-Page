import { FutureContent } from "./FutureContent.jsx";
import { useEffect, useState } from "react";
import { Brand, Mark } from "../../src/components/Brand.jsx";
import { BuildStory } from "../../src/components/BuildStory.jsx";
import { CommandDeck } from "../../src/components/CommandDeck.jsx";
import { CoreBenefits } from "../../src/components/CoreBenefits.jsx";
import { PageEffects } from "../../src/components/PageEffects.jsx";
import { PhoneDemo } from "../../src/components/PhoneDemo.jsx";
import { ProductShowcase } from "../../src/components/ProductShowcase.jsx";
    ...
    <header className={`nav-shell ${scrolled ? "nav-shell--scrolled" : ""}`}>
      <nav className="nav container" aria-label="Main navigation">
        ...
        <div className={`nav__links ${open ? "nav__links--open" : ""}`}>
          ...
          <a href="#next" onClick={() => setOpen(false)}>
            What’s next
          </a>
          <a
...
function App() {
  return (
    <div id="top" className="future-page">
          ...
          <div className="container hero__inner">
            <div className="hero__copy">
              ...
              <p className="hero__lede">
                ...
                Telegram chat. Next, we’re building realistic schedules that
                adapt to your goals and actual progress.
              </p>
              <div className="hero__actions">
                ...
                <a className="text-link" href="#next">
                  Explore what’s next <ArrowRight size={17} />
                </a>
              </div>
              <div className="hero__proof">
                ...
                <p>
                  <strong>Working Telegram prototype available.</strong>
                  <span>
                    All your current tools. Adaptive planning in development.
                  </span>
                </p>
              </div>
            </div>
