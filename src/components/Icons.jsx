...
export const Telegram = (props) => (
  <Icon {...props}>
    <path d="m21 4-3.2 15.2c-.2 1.1-.9 1.4-1.8.9l-4.9-3.6-2.4 2.3c-.3.3-.5.5-1 .5l.4-5 9-8.1c.4-.4-.1-.6-.6-.2L5.4 13 1 11.6c-1-.3-1-1 .2-1.5L18.5 3.4c.8-.3 1.5.2 1.2 1.4" />
  </Icon>
);
